            ...
            with accelerator.accumulate(unet):
                ...
                # if accelerator.is_main_process: 
                    ...
                    if (step + 0) % args.vis_interval == 0:           
                        ...
                        # print dtype of encoder_hidden_states_cond
                        # print('dtype of encoder_hidden_states_cond: ', encoder_hidden_states_cond.dtype)
                        # print('dtype of encoder_hidden_states_nocond: ', encoder_hidden_states_nocond.dtype)
                        # print('dtype of input: ', input.dtype)
                        # # print dimensions
                        # print('shape of encoder_hidden_states_cond: ', encoder_hidden_states_cond.shape)
                        # print('shape of encoder_hidden_states_nocond: ', encoder_hidden_states_nocond.shape)
